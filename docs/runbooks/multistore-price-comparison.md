...
Corte diagnóstico offline ITAD `/deals/v2` cerrado 2026-06-18:

- `diagnose_itad_deals_v2_payload(payload, itad_id_to_appid=None, country="MX", include_marketplaces=False)` inspecciona payloads locales/redactados de `/deals/v2` sin leer archivos, hacer red, abrir OAuth ni tocar cache/UI/CLI.
