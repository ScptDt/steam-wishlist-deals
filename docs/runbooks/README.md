...
| `behavioral-signals-contract.md` | Diseñar o auditar `behavioral_signals_v1`, `behavioral_explanations_v1` y JSON interno antes de consumidores visibles | Taxonomía `data/behavioral_taxonomy_v1.json`, contrato advisory-only, degraded states y player profile futuro |
