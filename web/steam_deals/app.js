...
const CONFIG_FIELDS = ['vanity','key','hltb','output','discount','genres','family_json','wishlist_external_matches_json','play_access_json','itad_external_offers_cache','itad_key','compare','telegram_token','telegram_chat','discord_webhook'];
