...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_generated_file_actions_explain_open_vs_download_behavior(self) -> None:
        ...
        self.assertIn("function latestSmartAlertOptInPreviewPayload", app_js)
        self.assertIn("function renderLatestSmartAlertOptInPreview", app_js)
        self.assertIn("smart_alert_channel_opt_in_preview", app_js)
        self.assertIn("schema !== 'smart_alert_channel_opt_in_preview_v1'", app_js)
        self.assertIn("payload.send_ready !== false", app_js)
        self.assertIn("payload.external_send_enabled !== false", app_js)
        self.assertIn("data-latest-smart-alert-opt-in-preview", app_js)
        self.assertIn("Smart Alerts — preview de opt-in de canales", app_js)
        self.assertIn("Preview-only/dry-run", app_js)
        self.assertIn("no usa tokens/webhooks", app_js)
        self.assertIn("No soportados:", app_js)
        self.assertIn("Blockers:", app_js)
        self.assertIn("renderLatestSmartAlertOptInPreview(report)", app_js)
        self.assertIn(".latest-smart-alert-digest", app_css)
        self.assertIn(".latest-smart-alert-section", app_css)
        self.assertIn(".latest-smart-alert-opt-in-preview", app_css)
        ...
        self.assertIn("Abrir último reporte interactivo", app_js)
        self.assertIn("Abrir último Share HTML", app_js)
        self.assertIn("Abrir JSON técnico del último reporte", app_js)
        self.assertIn("Copiar URL del JSON del último reporte", app_js)
        self.assertIn("No se pudo abrir último reporte HTML", app_js)
        self.assertNotIn("Abrir ultimo", app_js)
        self.assertNotIn("ultimo JSON", app_js)
    ...
    def test_advanced_filters_are_compact_and_help_is_on_demand(self) -> None:
        ...
        self.assertIn("Comparar, alertas, programación local y exports", panel_markup)
    ...
    def test_smart_alert_thresholds_are_visible_as_local_preview_controls(self) -> None:
        ...
        self.assertIn('id="smart_alert_opt_in_preview"', index_html)
        self.assertIn('id="smart_alert_preview_channels"', index_html)
        self.assertIn('id="smart_alert_preview_reviewed"', index_html)
        self.assertIn('id="smart_alert_preview_allow_high_volume"', index_html)
        self.assertIn("preview/dry-run local", index_html)
        self.assertIn("no envía Telegram/Discord por juego", index_html)
        self.assertIn("no usa tokens/webhooks", index_html)
        self.assertIn("conserva send_ready=false", index_html)
        ...
        self.assertIn("smart_alert_opt_in_preview", app_js)
        self.assertIn("smart_alert_preview_channels", app_js)
        self.assertIn("smart_alert_preview_reviewed", app_js)
        self.assertIn("smart_alert_preview_allow_high_volume", app_js)
        self.assertIn("'alert_rise_pct'", app_js)
        self.assertIn("'alert_global_margin_pct'", app_js)
        self.assertIn("'alert_score_min'", app_js)
    ...
    def test_scheduler_controls_are_visible_foreground_local_only(self) -> None:
        ...
        self.assertIn("Primer plano y solo local", index_html)
        self.assertIn("funciona solo mientras Steam Tools permanece abierto", index_html)
        self.assertIn("daemon", index_html)
        self.assertIn("servicio", index_html)
        self.assertIn("cron", index_html)
        self.assertIn("Task Scheduler", index_html)
        self.assertIn("proceso oculto", index_html)
        self.assertIn("arranque automático", index_html)
        self.assertNotIn("Foreground/local-only", index_html)
        self.assertNotIn("works only while Steam Tools remains open", index_html)
        self.assertNotIn("service/servicio", index_html)
        self.assertNotIn("hidden process/proceso oculto", index_html)
        self.assertNotIn("autostart/auto-start", index_html)
    ...
    def test_scheduler_run_flow_reports_foreground_and_conflicts(self) -> None:
        ...
        self.assertIn("Primer plano y solo local", scheduler_block)
        ...
        self.assertIn(
            "daemon/servicio/cron/Task Scheduler/proceso oculto/arranque automático",
            scheduler_block,
        )
        self.assertIn("Usa Detener", scheduler_block)
        self.assertNotIn("Foreground/local-only", scheduler_block)
        self.assertNotIn("works only while Steam Tools remains open", scheduler_block)
    ...
    def test_latest_report_renders_recommended_collections(self) -> None:
        ...
        self.assertIn("Colecciones destacadas", app_js)
        self.assertIn("Atajos discovery/oferta desde el último reporte", app_js)
    ...
    def test_latest_report_renders_personalized_recommendations_inside_details(self) -> None:
        ...
        self.assertIn("function latestBehavioralCueTooltip", app_js)
        self.assertIn("function latestBehavioralCueKindLabel", app_js)
        self.assertIn("function latestBehavioralCueKindHelp", app_js)
        ...
        self.assertIn("¿Por qué está aquí?", app_js)
        self.assertIn("taxonomía local activados por tags/géneros", app_js)
        self.assertIn("no para predecir precio ni cambiar ranking", app_js)
        self.assertIn("Patrón principal", app_js)
        self.assertIn("Loop de juego", app_js)
        self.assertIn("Contexto de decisión", app_js)
        ...
        self.assertIn("data-latest-personalized-behavioral-help", app_js)
        self.assertIn("title=\"${escapeHtml(cue.tooltip)}\"", app_js)
        self.assertIn("aria-label=\"${escapeHtml(cue.tooltip)}\"", app_js)
        self.assertIn("tabindex=\"0\"", app_js)
        ...
        self.assertIn("latestVisiblePersonalizedItems", app_js)
        self.assertIn("sin señal personal suficiente; aparece por score del reporte", app_js)
        ...
        self.assertIn(".latest-personalized-behavioral-help", app_css)
        self.assertIn(".latest-personalized-behavioral-cues", app_css)
        self.assertIn(".latest-personalized-behavioral-cues span:focus-visible", app_css)
        self.assertIn("cursor: help", app_css)
    ...
    def test_latest_report_renders_advisory_offer_highlights(self) -> None:
        ...
        self.assertIn("Muy buen deal", app_js)
